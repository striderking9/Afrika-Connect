              ...
              <div className="sidebar-column col-lg-4 col-md-12 col-sm-12">
                <aside className="sidebar">
                  <div className="sidebar-widget company-widget">
                    <div className="widget-content">
                      ...
                      <ul className="company-info mt-0">
                        <li>
                          Secteur d'activité: <span>Dévéloppement d'application</span>
                        </li>
                        <li>
                          Taille de l'entreprise: <span>501-1,000</span>
                        </li>
                        <li>
                          Date de création: <span>2011</span>
                        </li>
                        <li>
                          Téléohone: <span>{employer?.phone}</span>
                        </li>
                        <li>
                          Email: <span>{employer?.email}</span>
                        </li>
                        <li>
                          Emplacement: <span>{employer?.location}</span>
                        </li>
                        <li>
                          Réseaux sociaux:
                          <Social />
                  ...
                  <div className="sidebar-widget">
                    {/* <!-- Map Widget --> */}
                    <h4 className="widget-title">Lieu de travail</h4>
                    <div className="widget-content">
