...
const CvUploader = () => {
    ...
    const cvManagerHandler = (e) => {
        ...
        if (!isExist) {
            ...
            setError("Ce fichier existe déjà");
        }
    };
            ...
            <div className="uploading-resume">
                <div className="uploadButton">
                    ...
                    <label className="cv-uploadButton" htmlFor="upload">
                        <span className="title">Glisser ici pour ajouter</span>
                        <span className="text">
                            La taille du fichier à télécharger est de (Max 5Mb) et 
                            les types de fichiers autorisés sont (.doc, .docx, .pdf).
                        </span>
