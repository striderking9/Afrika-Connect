  ...
  return (
    <ul className="notification-list">
      <li>
        ...
        <strong>Henry Wilson</strong> a appliqué pour le poste
      ...
      <li className="success">
        <span className="icon flaticon-briefcase"></span>
        <strong>Raul Costa</strong> a appliqué pour le poste
      ...
      <li>
        <span className="icon flaticon-briefcase"></span>
        <strong>Jack Milk</strong> a appliqué pour le poste
      ...
      <li>
        <span className="icon flaticon-briefcase"></span>
        <strong>Wade Warren</strong> a appliqué pour le poste
