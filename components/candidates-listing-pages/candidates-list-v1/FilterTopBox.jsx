      ...
      <div className="candidate-block-three" key={candidate.id}>
        <div className="inner-box">
          ...
          <div className="btn-box">
            ...
            >
              <span className="btn-title">Voir le profil</span>
            </Link>
          </div>
          {/* End btn-box */}
        </div>
      ...
      <div className="ls-switcher">
        <div className="showing-result">
          <div className="show-1023">
            ...
            >
              <span className="icon icon-filter"></span> Filtrer
            </button>
          </div>
          {/* Collapsible sidebar button */}

          <div className="text">
            <strong>{content?.length}</strong> emplois
          </div>
        </div>
        {/* End showing-result */}
        ...
        <div className="sort-by">
          ...
          <select
            ...
            value={sort}
          >
            <option value="">Trier par (default)</option>
